      ...
      const FilterContainer = document.querySelector(".portfolio-filter"),
            ...
            function myFunction() 
                {
                    window.open("https://www.facebook.com/rohith.nanil/");
                }
            function myFunction1() 
                {
                    window.open( "https://twitter.com/rohith_na23");
                }
            function myFunction2() 
                {
                    window.open( "https://www.linkedin.com/in/rohith-na/");
                }
            function myFunction3() 
                {
                    window.open( "https://www.instagram.com/rohith_na23/");
                }
